...
int main(int argc, char **argv)
{
        ...
        //Step-11:- Instead of using send and receive, we will use scatterv and gatherv
        //for(int k = 0; k < P; k++)
        int *myvec = (int *) malloc(sizeof(int) *N);
        int *offsetv = (int *) malloc(sizeof(int) *offset);
        MPI_Scatterv(a,offsetv,myvec,MPI_INT,a,N,MPI_INT,rank,MPI_COMM_WORLD);
        ...
        //MPI_Gatherv(myvec, offset, MPI_INT, a, offset, MPI_INT, rank,MPI_COMM_WORLD)
